-- =============================================
-- Payment System Fix
-- Fix user_subscriptions and subscription_plans tables
-- =============================================
...
-- Insert subscription plans if they don't exist (check by name to avoid duplicates)
INSERT INTO subscription_plans (id, name, description, price_monthly, price_yearly, features, gym_access_description)
SELECT 
  ...
  29.99,
  299.99,
  ARRAY['Access to basic gym equipment', 'Locker room access', 'Basic fitness assessment', 'Monthly progress tracking'],
  'Access to all partner gyms with basic amenities'
...
SELECT 
  ...
  'Premium',
  'Most popular choice with advanced features',
  49.99,
  499.99,
  ARRAY['All Basic features', 'Group fitness classes', 'Personal trainer consultation', 'Nutrition guidance', 'Premium equipment access', 'Sauna and spa access'],
  'Access to all partner gyms with premium amenities and classes'
...
SELECT 
  ...
  'Elite',
  'Ultimate fitness experience with VIP treatment',
  79.99,
  799.99,
  ARRAY['All Premium features', 'Unlimited personal training', 'Custom meal plans', 'Priority booking', 'VIP lounge access', '24/7 gym access', 'Guest passes', 'Equipment reservation'],
  'Access to all partner gyms with elite amenities and VIP services'
...
DO $$
BEGIN
    RAISE NOTICE '🎉 Payment System Fix Complete!';
    ...
    RAISE NOTICE '📊 Default plans: Basic, Premium, Elite inserted';
    RAISE NOTICE '';
